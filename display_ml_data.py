...
ax1.plot(grouped_data['temperature'], grouped_data['magnetization (actual)'], label='Average of Absolute Actual Magnetization', color='blue')
...
ax2.plot(grouped_data['temperature'], grouped_data['magnetization'], label='Average of Absolute Estimated Magnetization', color='orange')
